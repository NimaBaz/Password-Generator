...
link = Label(root, text="https://github.com/NimaBaz/Password-Generator")
link.pack()
link.bind("<Button-1>", lambda e: hyperlink("https://github.com/NimaBaz/Password-Generator"))
add_link = canvas.create_window(29, 280, anchor = NW, window = link)
